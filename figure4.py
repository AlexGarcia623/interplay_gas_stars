'''
This file is used to create Figure 4 of "Interplay of Stellar
...
# Create my own colormap from Spectral
mass_spacing = 1.0
...
axs[0].set_xlim( -11, -8.5 ) ## Note this will mess up anything z != 0
